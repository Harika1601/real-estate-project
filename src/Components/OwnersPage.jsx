...
const styles = {
  ...
  backBtn:{background:"#198754",color:"#fff",border:"none",padding:"10px 18px",borderRadius:"8px",cursor:"pointer",fontWeight:"bold",marginBottom:"20px"},
  ...
  card:{background:"#f8fff9",padding:"25px",borderRadius:"12px",border:"1px solid #dff3e4"},
  cardTitle:{marginBottom:"10px",color:"#198754"},
